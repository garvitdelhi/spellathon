...
class Step4 extends Component {
  ...
  constructor(props) {
    ...
    this.interval = setInterval(() => {
      if (typeof(Storage) !== "undefined") {
        ...
        localStorage.setItem('step4_ans_filled', JSON.stringify(filled_inputs));
      }
    }, 1000);
  }
  ...
  submit = () => {
    ...
    fetch("http://garvit-debian-8.corp.adobe.com:7080/step4", {
      method: 'POST',
  ...
  generateRows = (number, offset) => {
    ...
    if (typeof(Storage) !== "undefined") {
      filled_inputs = localStorage.getItem('step4_ans_filled');
